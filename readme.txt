...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\experimentaltoolbar on
     Windows, /home/user/dev/experimentaltoolbar on Linux) in a file named
     experimentaltoolbar@bryan.clark and copy that file to
